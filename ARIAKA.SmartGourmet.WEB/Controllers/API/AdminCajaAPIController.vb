...
#Region "get cajas"
        ...
        Public Async Function GetCajas() As Task(Of IHttpActionResult)
            ...
            Try
                ...
                If cajas Is Nothing AndAlso cajas.Count Then Return Me.Content(HttpStatusCode.BadRequest, "No Existe Cajas Creadas")
...
#End Region
        ...
        Public Function AddCajas(<FromBody> model As Models.AdminCajaDTO) As IHttpActionResult
            If model Is Nothing Then
                Return Me.Content(HttpStatusCode.BadRequest, "Sin Datos en la bd")
            End If
            ...
            Try
                ...
                Dim cajas As New Caja With {.FechaInicio = model.FechaInicio, .Turno = model.Turno, .SaldoInicial = model.SaldoInicial}
                db.Cajas.Add(cajas)
                db.SaveChanges()
                model.ID = cajas.ID
                Return Me.Ok(model)
