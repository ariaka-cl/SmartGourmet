...
Namespace Migrations
    ...
    Public NotInheritable Partial Class RemovedTipoID
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(RemovedTipoID))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201902140444321_RemovedTipoID"
            End Get
        End Property
